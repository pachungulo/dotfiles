...
api.addSearchAlias('w', 'wikipedia', 'https://en.wikipedia.org/wiki/', 's', 'https://en.wikipedia.org/w/api.php?action=opensearch&search=', function(response) {
   return JSON.parse(response.text)[1];
});

api.addSearchAlias('b', 'bunnysearch', 'https://bunnysear.ch/?q=', 's', 'https://duckduckgo.com/ac/?q=', function(response) {
...
api.addSearchAlias('B', 'bravesearch', 'https://search.brave.com/search?q=', 's', 'https://search.brave.com/api/suggest?q=', function(response) {
    return JSON.parse(response.text)[1];
});
